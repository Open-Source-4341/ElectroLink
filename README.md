...
|-------------------------|--------------------------|------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Del Aguila Ayala, Ricardo Alejandro**  <br> **TB1:** Trabajé en la arquitectura del software aplicando Domain-Driven Design. Redacté historias de usuario, lideré la implementación de la landing page y documenté técnicamente cada componente. <br> **TP:** Coordiné la documentación del Sprint 2, incluyendo el Sprint Planning, Backlog y evidencias técnicas. Me enfoqué en comunicar con precisión los avances del equipo en el repositorio y en mantener alineadas las entregas técnicas con los criterios definidos. <br> **TB2:** Me encargué de revisar la consistencia entre las evidencias y los criterios de validación. Redacté parte de las conclusiones y lideré la organización de entrevistas de validación, asegurando claridad en las instrucciones y en la interpretación de los hallazgos. <br>  <br> **Sánchez Manrique, Italo Ludwing** <br> **TB1:** Participé en la elaboración de User Persona, diagramas de flujo y prototipos web. También contribuí en la guía de estilos asegurando coherencia visual. <br> **TP:** Lideré la implementación de funcionalidades en mi módulo del frontend. Documenté los endpoints usados y colaboré en el Sprint Review. Me aseguré de que la lógica visual reflejara fielmente las necesidades funcionales del sistema. <br> **TB2:** Apoyé en el diseño del protocolo de entrevistas y participé en las validaciones con usuarios. Aporté observaciones clave en la discusión de resultados y cómo estos se reflejaban en el sistema. <br>  <br> **Machado Bracamonte, Ivo Marcelo** <br> **TB1:** Me encargué del sistema de etiquetado, mock-ups y diseño visual de la landing page. Aporté prototipos para guiar el desarrollo del frontend. <br> **TP:** Implementé y documenté vistas funcionales del frontend en mi carpeta de trabajo. Mostré visualmente los avances en el Sprint Review y elaboré evidencia gráfica con capturas y video del sistema. <br> **TB2:** Coordiné la presentación de evidencias visuales de implementación y validación. Elaboré recursos gráficos y esquemas explicativos para las entrevistas y para el informe final del Sprint. <br> <br> **Aliaga Aguirre, Ethan Matías** <br> **TB1:** Contribuí al diseño orientado a objetos e implementación técnica de la landing page. Coordiné con el equipo para asegurar calidad estructural del sistema. <br> **TP:** Participé en el desarrollo técnico del módulo correspondiente a mi bounded context. Aporté evidencia de implementación y colaboré en tareas de integración del frontend. <br> **TB2:** Aporté en la revisión cruzada del código implementado, validando que los cambios respondieran a las entrevistas y evaluaciones heurísticas. Documenté mejoras técnicas aplicadas.<br> <br> **Contreras Lopez, Leandro Saúl** <br> **TB1:** Configuré el entorno de desarrollo común y gestioné el Product Backlog. También trabajé en las metaetiquetas SEO. <br> **TP:** Reestructuré la carpeta de trabajo para mi bounded context. Contribuí en la documentación del Sprint y la implementación de funcionalidades específicas. Organicé evidencias de implementación y validación de servicios. <br> **TB2:** Gestioné la integración de evidencias de entrevistas y evaluación heurística en el repositorio. Organicé las entregas del equipo y verifiqué que cumplieran con los criterios de formato.| **TB1:** Cada miembro evidencio la capacidad para expresar temas técnicos y complejos, manteniendo la comunicación activa y eficaz que fortaleció el trabajo como grupo, algo sumamente importante para proyectos en equipo <br> **TP:** Durante este TP, la comunicación constante se mantuvo facilitando la delegación de tareas con respecto a la implementación, lo que permitió a cada miembro ajustar sus tiempos con el fin de brindar un entregable de calidad. <br> **TB2:** Durante este TB2, donde se abarcó la metodologia de trabajar en base a aspectos, notamos una mejora significativa en la comunicación continua durante el desarollo del proyecto, lo cual se reflejó en la presentación y la calidad de la solución. |
...
| US-67 | Visualización de historial de consumo | Como propietario, quiero visualizar gráficamente mi historial de consumo eléctrico, el cual se genera a partir de los datos de los recibos que he subido en mis solicitudes de servicio, para identificar tendencias y patrones. | Escenario #1: Visualización de gráficos de consumo<br>Dado que que un Propietario tiene registros de consumo de recibos anteriores<br>Cuando accede a su panel de analíticas<br>Entonces el sistema muestra gráficos de su consumo eléctrico a lo largo del tiempo. | EP-05 |
| US-68 | Exportación de datos de consumo | Como usuario, quiero exportar mis datos históricos de consumo en formatos comunes (CSV, Excel) para análisis externos | Escenario #1: Exportación de datos<br>Dado que que un Propietario está en su panel de analíticas de consumo<br>Cuando solicita exportar sus datos<br>Entonces el sistema genera un archivo en un formato estándar (CSV) con su historial de consumo. | EP-05 |
| US-69 | Repositorio de facturas | Como usuario, quiero tener un repositorio organizado de todas mis facturas eléctricas para acceder fácilmente a ellas cuando las necesite | Escenario #1: Almacenamiento de facturas<br>Dado que que un Propietario ha subido una imagen de su factura durante una solicitud<br>Cuando accede a su repositorio de facturas<br>Entonces la factura se encuentra almacenada y puede ser consultada. | EP-05 |
| US-70 | Verificación de facturas | Como usuario, quiero verificar si el cálculo de mi factura es correcto según las tarifas vigentes para detectar posibles errores de facturación | Escenario #1: Detección de discrepancia<br>Dado que que un Propietario ha subido una factura y el sistema conoce las tarifas vigentes<br>Cuando el sistema compara el cálculo propio con el monto facturado y detecta una diferencia significativa<br>Entonces resalta la discrepancia<br>Y ofrece un informe detallado de la verificación. | EP-07 |
| US-71 | Configuración de alertas de consumo | Como usuario, quiero configurar alertas personalizadas cuando mi consumo supere ciertos umbrales predefinidos para tomar medidas proactivas | Escenario #1: Creación de alerta<br>Dado que que un Propietario está en la sección de alertas de consumo<br>Cuando establece un umbral de consumo máximo mensual<br>Entonces el sistema registra la alerta.<br><br>Escenario #2: Notificación de alerta<br>Dado que que un Propietario tiene una alerta configurada<br>Cuando un nuevo registro de consumo provoca que se supere el umbral establecido<br>Entonces el sistema le envía una notificación. | EP-05 |
| US-72 | Sistema de Recomendaciones Personalizadas | Como cliente, quiero recibir recomendaciones personalizadas de servicios y productos basados en mi historial y necesidades, para descubrir soluciones relevantes que puedan mejorar mi experiencia. | Escenario #1: Visualización de recomendaciones<br>Dado que que un Propietario ha utilizado servicios anteriormente<br>Cuando accede a su panel principal<br>Entonces visualiza sugerencias de servicios o mantenimientos basados en su historial. | EP-07 |
| US-73 | Visualización de Calificaciones y Reseñas Recibidas | Como técnico registrado, quiero visualizar un resumen gráfico y detallado de mis calificaciones y reseñas recibidas, para monitorear la calidad percibida de mis servicios, identificar áreas de mejora y usar esta información como reputación. | Escenario #1: Resumen de desempeño<br>Dado que que un Técnico ha recibido calificaciones por sus servicios<br>Cuando accede a su panel de analíticas<br>Entonces visualiza un resumen gráfico de sus calificaciones promedio<br>Y puede ver una lista detallada de todos los comentarios recibidos. | EP-06 |
| US-74 | Análisis de Demanda por Zona Geográfica | Como técnico registrado, quiero acceder a un análisis visual de la demanda histórica de servicios por zona geográfica, para optimizar mi cobertura, planificar expansiones, ajustar mis precios y mejorar la gestión de inventario por zona. | Escenario #1: Visualización de mapa de calor de demanda<br>Dado que que un Técnico tiene zonas de cobertura definidas<br>Cuando accede a su panel de analíticas de demanda<br>Entonces visualiza una representación visual (ej. mapa) que muestra qué tipos de servicios son más solicitados en cada zona. | EP-06 |
| US-75 | Recibir Confirmación de Suscripción | Como usuario que acaba de suscribirse, quiero recibir una confirmación inmediata por email y ver mi perfil actualizado, para tener la seguridad de que el pago fue exitoso y mi plan está activo. | Escenario #1: Confirmación de suscripción exitosa<br>Dado que que un usuario ha completado el proceso de pago para un plan Premium<br>Cuando el pago es procesado exitosamente<br>Entonces recibe una notificación de confirmación por email<br>Y el estado de su cuenta en el sistema se actualiza inmediatamente para reflejar su nuevo plan. | EP-09 |
| US-76 | Gestionar Suscripción Activa | Como usuario con un plan Premium, quiero acceder a un portal de cliente unificado para  ver mi historial de facturas, actualizar mi método de pago o cancelar mi plan, sin importar si soy técnico o propietario. | Escenario #1: Acceder al portal de gestión<br>Dado que que un usuario con suscripción Premium está autenticado<br>Cuando solicita gestionar su suscripción<br>Entonces es dirigido de forma segura al portal donde puede ver su historial de pagos y método de pago actual. | EP-09 |
| US-77 | Suscribirse al Plan Premium de Propietario | Como Propietario, quiero  suscribirme al plan Premium cuando alcance mi límite, para desbloquear las solicitudes ilimitadas y la opción de prioridad. | Escenario #1: Actualización a Premium<br>Dado que que un Propietario con plan Básico ha sido notificado de que alcanzó su límite<br>Cuando elige la opción para mejorar su plan y completa el proceso de pago<br>Entonces su cuenta se actualiza al plan Premium<br>Y obtiene acceso a solicitudes ilimitadas y la opción de prioridad. | EP-09 |
| US-78 | Suscribirse al Plan Premium de Técnico | Como Técnico, quiero suscribirme al plan Premium para activar mi catálogo de servicios, obtener un badge de "Premium" en mi perfil y tener prioridad en las asignaciones. | Escenario #1: Activación de cuenta de Técnico<br>Dado que que un Técnico recién registrado quiere activar sus funcionalidades<br>Cuando se suscribe a un plan Premium y completa el pago<br>Entonces su catálogo de servicios se activa<br>Y su perfil público muestra una insignia de "Premium". | EP-09 |
| US-79 | Cancelar mi suscripción | Como usuario suscrito en un plan, Quiero cancelar mi suscripción en cualquier momento Para dejar de recibir cargos automáticos | Escenario #1: Cancelación de la suscripción<br>Dado que que un usuario con una suscripción activa está en el portal de gestión<br>Cuando elige la opción de cancelar su suscripción y confirma su decisión<br>Entonces el sistema programa la cancelación para el final del ciclo de facturación actual<br>Y el usuario es notificado de la fecha en que sus beneficios expirarán. | EP-09 |
| US-80 | Manejo de Fallos en la Renovación | Como usuario con un plan Premium, si el cobro automático de mi renovación mensual falla, quiero recibir una notificación por email para  actualizar mis datos de pago a tiempo y no perder mis beneficios. | Escenario #1: Notificación de fallo en el pago<br>Dado que que el pago recurrente de la suscripción de un usuario falla<br>Cuando el sistema de pagos informa del fallo<br>Entonces el sistema envía una notificación al usuario informándole del problema<br>Y le proporciona instrucciones para actualizar su método de pago. | EP-09 |
...
| Epic/StoryID | Título | Descripción | Criterios de aceptación | Relacionado con epica |
|--------------|--------|-------------|-------------------------|----------------------|
| TS-17 | Sistema de Autenticación JWT | Como desarrollador, necesito implementar un sistema de autenticación basado en JWT para gestionar las sesiones de usuarios de forma segura y escalable. | **Escenario 1: Generación exitosa de token JWT** <br> Dado que el sistema recibe credenciales válidas de un usuario. <br> Cuando se procesa la solicitud de autenticación <br> Entonces el sistema genera un token JWT con la información del usuario <br> Y el token incluye el rol del usuario (propietario/técnico) Y el token tiene una expiración configurada. <br> <br>  **Escenario 2: Validación de token JWT** <br> Dado que el sistema recibe una petición con un token JWT <br> Cuando se valida el token <br> Entonces el sistema verifica la firma del token <br> Y confirma que el token no ha expirado <br> Y extrae la información del usuario del payload. <br> <br> **Escenario 3: Manejo de tokens inválidos** <br> Dado que el sistema recibe un token JWT inválido o expirado <br> Cuando se intenta validar el token <br> Entonces el sistema rechaza la petición <br> Y retorna un error de autenticación apropiado | EP-01 |
| TS-18 | Endpoint de Registro de Usuarios | Como desarrollador, necesito crear endpoints para el registro de usuarios diferenciado por tipo (propietario/técnico) para soportar los diferentes flujos de onboarding. | **Escenario: Registro exitoso de propietario** <br> Dado que el sistema recibe una petición POST con datos válidos de propietario <br> Cuando se procesa el registro <br> Entonces el sistema crea el usuario con rol de propietario <br> Y encripta la contraseña <br> Y asigna el plan básico por defecto <br> Y envía email de verificación <br> <br> **Escenario: Registro exitoso de técnico** <br> Dado que el sistema recibe una petición POST con datos válidos de técnico <br> Cuando se procesa el registro <br> Entonces el sistema crea el usuario con rol de técnico <br> Y almacena las certificaciones proporcionadas <br> Y configura la zona de cobertura inicial <br> Y envía email de verificación <br> <br> **Escenario: Validación de datos duplicados** <br> Dado que se intenta registrar un usuario con email ya existente <br> Cuando se procesa el registro <br> Entonces el sistema rechaza la petición <br> Y retorna un error indicando email duplicado | EP-01 |
| TS-19 | Verificación de Email | Como desarrollador, necesito implementar un sistema de verificación de email para asegurar la validez de las cuentas y cumplir con las políticas de seguridad. | **Escenario: Envío de email de verificación** <br> Dado que se registra un nuevo usuario <br> Cuando se completa el registro <br> Entonces el sistema genera un token de verificación único <br> Y envía un email con el enlace de verificación <br> Y marca el usuario como "pendiente de verificación" <br> <br> **Escenario: Verificación exitosa de email** <br> Dado que un usuario accede al enlace de verificación válido <br> Cuando se procesa la verificación <br> Entonces el sistema marca la cuenta como verificada <br> Y habilita el acceso completo a la plataforma <br> Y retorna confirmación de verificación exitosa <br> <br> **Escenario: Token de verificación expirado** <br> Dado que un usuario intenta verificar con un token expirado <br> Cuando se procesa la verificación <br> Entonces el sistema rechaza la verificación <br> Y ofrece opción de reenviar email de verificación | EP-02 |
| TS-20 | Middleware de Autorización por Roles | Como desarrollador, necesito implementar middleware para controlar el acceso a endpoints según el rol del usuario y tipo de suscripción para mantener la seguridad del sistema. | **Escenario: Acceso autorizado por rol** <br> Dado que un usuario autenticado accede a un endpoint <br> Cuando el middleware verifica los permisos <br> Y el rol del usuario coincide con los requeridos <br> Entonces el sistema permite el acceso al endpoint <br> <br> **Escenario: Acceso denegado por rol insuficiente** <br> Dado que un usuario intenta acceder a un endpoint restringido <br> Cuando el middleware verifica los permisos <br> Y el rol del usuario no tiene los permisos necesarios <br> Entonces el sistema rechaza el acceso <br> Y retorna error de autorización <br> <br> **Escenario: Verificación de plan de suscripción** <br> Dado que un usuario accede a una funcionalidad premium <br> Cuando el middleware verifica la suscripción <br> Y el usuario no tiene plan premium activo <br> Entonces el sistema rechaza el acceso <br> Y retorna información sobre limitaciones del plan | EP-03 |
| TS-21 | Recuperación de Contraseña | Como desarrollador, necesito implementar un sistema seguro de recuperación de contraseña mediante email para permitir el acceso a usuarios que olviden sus credenciales. | **Escenario: Solicitud de recuperación válida** <br> Dado que el sistema recibe una solicitud de recuperación con email válido <br> Cuando se procesa la solicitud <br> Entonces el sistema genera un token de recuperación temporal <br> Y envía email con enlace de recuperación <br> Y configura expiración del token <br> <br> **Escenario: Cambio exitoso de contraseña** <br> Dado que un usuario accede con token de recuperación válido <br> Cuando proporciona nueva contraseña válida <br> Entonces el sistema actualiza la contraseña encriptada <br> Y invalida todos los tokens de recuperación previos <br> Y confirma el cambio exitoso <br> <br> **Escenario: Token de recuperación inválido** <br> Dado que se intenta usar un token de recuperación inválido o expirado <br> Cuando se procesa el cambio de contraseña <br> Entonces el sistema rechaza la operación <br> Y retorna error apropiado | EP-03 |
| TS-22 | Endpoint de Gestión de Perfiles | Como desarrollador, necesito crear endpoints para visualizar y editar perfiles de usuario para soportar la funcionalidad de gestión de cuentas diferenciada por tipo de usuario. | **Escenario: Obtención de perfil de propietario** <br> Dado que un propietario autenticado solicita su perfil <br> Cuando se procesa la petición GET <br> Entonces el sistema retorna la información personal del propietario <br> Y incluye las preferencias configuradas <br> Y omite información sensible como contraseñas <br> <br> **Escenario: Actualización de perfil de técnico** <br> Dado que un técnico envía datos actualizados de perfil <br> Cuando se procesa la petición PUT <br> Entonces el sistema valida los datos recibidos <br> Y actualiza las certificaciones y especialidades <br> Y confirma la actualización exitosa <br> <br> **Escenario: Validación de datos de perfil** <br> Dado que el sistema recibe datos inválidos en actualización de perfil <br> Cuando se validan los datos <br> Entonces el sistema rechaza los datos inválidos <br> Y retorna errores específicos por campo | EP-03 |
| TS-23 | Sistema de Notificaciones | Como desarrollador, necesito implementar un sistema de notificaciones multi-canal (email, SMS, push) para soportar la comunicación automatizada con los usuarios. | **Escenario: Envío de notificación por email** <br> Dado que se debe enviar una notificación <br> Cuando se procesa la notificación <br> Y el usuario tiene habilitadas notificaciones por email <br> Entonces el sistema envía el email con el contenido apropiado <br> Y registra el envío en los logs <br> <br> **Escenario: Respeto de preferencias de usuario** <br> Dado que un usuario ha configurado sus preferencias de notificación <br> Cuando se debe enviar una notificación <br> Entonces el sistema envía solo por los canales habilitados por el usuario <br> Y respeta la frecuencia configurada <br> <br> **Escenario: Manejo de fallos en envío** <br> Dado que falla el envío de una notificación <br> Cuando se detecta el fallo <br> Entonces el sistema registra el error en logs <br> Y programa un reintento según configuración | EP-04, EP-05 |
| TS-24 | Servicio de Analytics de Consumo | Como desarrollador, necesito crear un servicio que procese y analice los datos de consumo eléctrico para generar insights y métricas para los propietarios. | **Escenario: Procesamiento de datos de recibos** <br> Dado que el sistema recibe datos de un recibo eléctrico <br> Cuando se procesan los datos <br> Entonces el sistema extrae las métricas de consumo <br> Y almacena en formato normalizado <br> Y calcula tendencias automáticamente <br> <br> **Escenario: Generación de insights de consumo** <br> Dado que existen datos históricos de consumo <br> Cuando se solicita análisis de consumo <br> Entonces el sistema calcula promedios mensuales <br> Y identifica patrones de consumo <br> Y genera recomendaciones básicas <br> <br> **Escenario: Detección de anomalías** <br> Dado que se analizan datos de consumo recientes <br> Cuando se detecta consumo atípico <br> Entonces el sistema marca como anomalía <br> Y genera alerta si está configurada | EP-05 |
| TS-25 | Exportación de Datos | Como desarrollador, necesito implementar funcionalidad para exportar datos de consumo en múltiples formatos para satisfacer las necesidades de análisis externo de los usuarios. | **Escenario: Exportación exitosa en formato CSV** <br> Dado que un usuario solicita exportar datos en CSV <br> Cuando se procesa la solicitud <br> Entonces el sistema genera los datos en formato CSV válido <br> Y incluye headers descriptivos <br> Y retorna el archivo para descarga <br> <br> **Escenario: Exportación con filtros de fecha** <br> Dado que se solicita exportación con rango de fechas <br> Cuando se aplican los filtros <br> Entonces el sistema incluye solo los datos del período solicitado <br> Y mantiene la estructura de datos consistente <br> <br> **Escenario: Manejo de datasets grandes** <br> Dado que se solicita exportar gran cantidad de datos <br> Cuando el dataset excede límites configurados <br> Entonces el sistema procesa por lotes <br> Y notifica al usuario sobre el procesamiento | EP-05 |
| TS-26 | Dashboard de Métricas para Técnicos | Como desarrollador, necesito crear endpoints que proporcionen métricas de desempeño y rentabilidad para soportar el dashboard de técnicos. | **Escenario: Cálculo de métricas de servicios** <br> Dado que un técnico solicita sus métricas <br> Cuando se calculan las estadísticas <br> Entonces el sistema incluye servicios completados <br> Y calcula rating promedio <br> Y determina ingresos por período <br> <br> **Escenario: Análisis de rentabilidad** <br> Dado que se solicitan métricas financieras <br> Cuando se procesan los datos <br> Entonces el sistema calcula costos de materiales utilizados <br> Y determina márgenes de ganancia por servicio <br> Y identifica servicios más rentables <br> <br> **Escenario: Métricas de eficiencia temporal** <br> Dado que se analizan tiempos de servicio <br> Cuando se procesan los datos temporales <br> Entonces el sistema calcula tiempo promedio por tipo de servicio <br> Y identifica eficiencia relativa <br> Y sugiere optimizaciones de tiempo | EP-06 |
| TS-27 | Verificador de Facturas | Como desarrollador, necesito implementar un servicio que verifique la precisión de cálculos en facturas eléctricas para detectar discrepancias y errores de facturación. | **Escenario: Verificación de cálculo básico** <br> Dado que el sistema recibe datos de una factura <br> Cuando se verifica el cálculo <br> Entonces el sistema valida el consumo reportado <br> Y verifica las tarifas aplicadas <br> Y calcula el monto esperado <br> <br> **Escenario: Detección de discrepancias** <br> Dado que existe diferencia entre cálculo esperado y facturado <br> Cuando se completa la verificación <br> Entonces el sistema marca la discrepancia encontrada <br> Y especifica el tipo de error detectado <br> Y calcula la diferencia monetaria <br> <br> **Escenario: Actualización de tarifas vigentes** <br> Dado que se actualizan las tarifas eléctricas oficiales <br> Cuando se procesan las nuevas tarifas <br> Entonces el sistema actualiza los parámetros de cálculo <br> Y re-verifica facturas recientes si es necesario | EP-07 |
| TS-28 | Sistema de Alertas de Consumo | Como desarrollador, necesito implementar un sistema que genere alertas automáticas cuando el consumo supere umbrales configurados para proporcionar monitoreo proactivo. | **Escenario: Configuración de umbrales** <br> Dado que un usuario configura alertas de consumo <br> Cuando se almacenan las configuraciones <br> Entonces el sistema valida los umbrales proporcionados <br> Y activa el monitoreo automático <br> Y confirma la configuración exitosa <br> <br> **Escenario: Detección y envío de alerta** <br> Dado que el consumo supera un umbral configurado <br> Cuando se detecta la condición <br> Entonces el sistema genera una alerta automática <br> Y envía notificación según preferencias del usuario <br> Y registra la alerta generada <br> <br> **Escenario: Prevención de spam de alertas** <br> Dado que el consumo se mantiene sobre el umbral <br> Cuando se evalúa generar nueva alerta <br> Y ya se envió alerta reciente por la misma condición <br> Entonces el sistema evita enviar alerta duplicada <br> Y respeta el intervalo mínimo configurado | EP-05 |
| TS-29 | Análisis de Demanda Geográfica | Como desarrollador, necesito crear un servicio que analice la demanda de servicios por zona geográfica para proporcionar insights de negocio a los técnicos. | **Escenario: Agregación de datos por zona** <br> Dado que existen solicitudes de servicio históricas <br> Cuando se agregan por zona geográfica <br> Entonces el sistema calcula estadísticas por área <br> Y identifica zonas de alta demanda <br> Y determina tipos de servicio más solicitados <br> <br> **Escenario: Identificación de oportunidades** <br> Dado que se analiza la demanda vs oferta por zona <br> Cuando se detectan desbalances <br> Entonces el sistema identifica zonas con poca cobertura <br> Y calcula oportunidades de expansión <br> Y prioriza por potencial de ingresos <br> <br> **Escenario: Tendencias temporales por zona** <br> Dado que se analizan patrones temporales de demanda <br> Cuando se procesan datos históricos <br> Entonces el sistema identifica estacionalidades por zona <br> Y predice períodos de alta demanda <br> Y sugiere estrategias de capacidad | EP-06 |
| TS-30 | Sistema de Recomendaciones | Como desarrollador, necesito implementar un sistema de recomendaciones personalizadas basado en algoritmos de machine learning para mejorar la experiencia del usuario y aumentar el engagement. | **Escenario: Recomendaciones para propietarios** <br> Dado que un propietario tiene historial de servicios <br> Cuando se generan recomendaciones <br> Entonces el sistema analiza servicios previos contratados <br> Y identifica necesidades recurrentes <br> Y recomienda servicios preventivos relevantes <br> <br> **Escenario: Recomendaciones para técnicos** <br> Dado que un técnico tiene historial de servicios <br> Cuando se analizan sus datos <br> Entonces el sistema identifica servicios más rentables <br> Y recomienda certificaciones adicionales <br> Y sugiere expansiones de zona de cobertura <br> <br> **Escenario: Aprendizaje continuo del sistema** <br> Dado que los usuarios interactúan con recomendaciones <br> Cuando se registran aceptaciones o rechazos <br> Entonces el sistema ajusta los algoritmos de recomendación <br> Y mejora la precisión de futuras sugerencias <br> Y personaliza más el perfil del usuario | EP-07 |
...
| US-79 | Cancelar mi suscripción | Como usuario suscrito en un plan, Quiero cancelar mi suscripción en cualquier momento Para dejar de recibir cargos automáticos. | 3 |
...
| US-75 | Recibir Confirmación de Suscripción | Como usuario que acaba de suscribirse, quiero recibir una confirmación inmediata por email y ver mi perfil actualizado, para tener la seguridad de que el pago fue exitoso y mi plan está activo. | 5 |
| US-77 | Suscribirse al Plan Premium de Propietario | Como Propietario, quiero suscribirme al plan Premium cuando alcance mi límite, para desbloquear las solicitudes ilimitadas y la opción de prioridad. | 5 |
| US-80 | Manejo de Fallos en la Renovación | Como usuario con un plan Premium, si el cobro automático de mi renovación mensual falla, quiero recibir una notificación por email para actualizar mis datos de pago a tiempo y no perder mis beneficios. | 5 |
...
| US-76 | Gestionar Suscripción Activa | Como usuario con un plan Premium, quiero acceder a un portal de cliente unificado para ver mi historial de facturas, actualizar mi método de pago o cancelar mi plan, sin importar si soy técnico o propietario. | 8 |
| US-78 | Suscribirse al Plan Premium de Técnico | Como Técnico, quiero suscribirme al plan Premium para activar mi catálogo de servicios, obtener un badge de Premium en mi perfil y tener prioridad en las asignaciones. | 8 |
