...
|-------------------------|--------------------------|------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Del Aguila Ayala, Ricardo Alejandro** | Durante el desarrollo del proyecto, trabajé en la arquitectura del software utilizando un enfoque basado en dominios. Redacté historias de usuario para alinear la visión del equipo y lideré la implementación de la landing page detallada en el Capítulo V. | Su comunicación técnica fue esencial para coordinar desde la arquitectura hasta la entrega. Supo traducir conceptos complejos en historias claras, facilitando una ejecución ordenada y alineada al objetivo del proyecto. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Sánchez Manrique, Italo Ludwing** | Me encargué de desarrollar los User Personas y de analizar las entrevistas realizadas a los usuarios. Además, diagramé wireflows para las aplicaciones web, elaboré la guía de estilo del proyecto y participé en la creación de prototipos. | Destacó por su claridad al comunicar necesidades de usuarios y plasmarlas en entregables visuales. Facilitó decisiones de diseño efectivas y alineadas al enfoque centrado en el usuario. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Machado Bracamonte, Ivo Marcelo** | Colaboré en el diseño del sistema de etiquetado, en la interfaz gráfica de la landing page, y realicé mock-ups y prototipos interactivos para las aplicaciones web, asegurando coherencia visual y funcional. | Logró comunicar visualmente la estructura e identidad del producto. Su trabajo ayudó a mantener la coherencia de las interfaces y permitió una mejor interpretación por parte del equipo técnico. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Aliaga Aguirre, Ethan Matías** | Aporté en el diseño orientado a objetos del software y participé en la implementación técnica de la landing page en el Capítulo V, manteniendo comunicación constante con el equipo de desarrollo. | Contribuyó eficazmente en la traducción del diseño técnico en componentes funcionales. Mantuvo una comunicación técnica clara con el equipo, garantizando coherencia y funcionalidad en el desarrollo. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Contreras Lopez, Leandro Saúl** | Me ocupé de configurar el entorno de desarrollo, elaborar el backlog del producto y gestionar los elementos relacionados con SEO y etiquetas meta para mejorar la visibilidad del sitio. | Fue clave en la planificación y base técnica del sistema. Su comunicación facilitó la integración del entorno de trabajo y una gestión efectiva del backlog con visión técnica y estratégica. |
