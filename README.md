...
| :---- | :---- | :---- |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | \-Del Aguila Ayala Ricardo Alejandro TB1: En el TB1, me comprometí con el desarrollo técnico del producto y con la gestión del repositorio. Apoyé en la configuración del entorno de desarrollo y en el control de versiones, asegurando una integración ordenada del código. Considero que promoví una buena dinámica de grupo, basada en la confianza, responsabilidad compartida y constante aprendizaje entre todos.   \-Machado Bracamonte Ivo Marcelo TB1: Durante el desarrollo del proyecto, me involucré activamente en la definición del problema y en la identificación de requerimientos. Aporté ideas clave en la creación de los *User Personas* y en el análisis de competencia, lo cual nos ayudó a entender mejor al usuario final. Además, trabajé de manera colaborativa para garantizar que cada entrega reflejara una visión coherente del producto.  \-Aliaga Aguirre Ethan Matias TB1: Participé en la planificación y ejecución del Sprint 1, colaborando en la definición del backlog y la asignación de tareas. Contribuí en el desarrollo del prototipo y en la implementación de funcionalidades iniciales, manteniendo una buena comunicación con el equipo. Mi enfoque estuvo en asegurar que nuestras decisiones técnicas respondieran a lo aprendido en el Journey Mapping y Empathy Mapping. \-Contreras Lopez Leandro Saúl TB1: Mi participación se enfocó en el análisis de requerimientos y la validación de hipótesis usando herramientas UX. Fui parte activa en las entrevistas a usuarios y en el análisis competitivo, lo que nos permitió entender mejor las oportunidades del mercado. Además, colaboré en la elaboración de los entregables técnicos, cuidando que cada parte cumpliera con las convenciones del equipo. \-Sanchez Manrique Italo Ludwing TB1: Me encargué de parte del diseño del producto y ayudé en la documentación de servicios. Fomenté el trabajo en equipo al apoyar a mis compañeros cuando surgían dudas técnicas, y participé en las revisiones del Sprint aportando retroalimentación constructiva. Creo que mi rol fue clave para mantener la coherencia en el diseño y funcionalidad de *Electrolink*. | TB1: En el Capítulo I, se estableció el perfil de Electrolink, detallando el propósito de la startup, los roles fundamentales del equipo y sus competencias técnicas. Se definió la problemática principal que la solución busca atender, aplicando el enfoque Lean UX para validar suposiciones y mapear la propuesta de valor. Esta fase permitió entender con claridad qué se necesita resolver, y a quiénes irá dirigido, garantizando que todo el diseño y desarrollo se oriente a cubrir necesidades reales de los usuarios. En el Capítulo II, se abordó la elicitación y análisis de requerimientos, combinando entrevistas con usuarios, benchmarking de soluciones similares y herramientas como los User Personas, Empathy Maps y Journey Maps. Esto permitió comprender a profundidad la experiencia de los usuarios, sus frustraciones y objetivos, así como visualizar cómo interactúan con Electrolink en cada etapa del proceso, sentando las bases para decisiones de diseño más empáticas y funcionales. En el Capítulo III, se formalizaron los requerimientos recopilados en especificaciones claras y organizadas, facilitando una visión técnica del producto. Se agruparon requerimientos funcionales y no funcionales, priorizando los más relevantes para la experiencia del usuario y la escalabilidad del sistema. En el Capítulo IV, se desarrolló el diseño del producto, comenzando con wireframes, prototipos de baja y alta fidelidad, y diagramas arquitectónicos que reflejan la estructura lógica del sistema. Se diseñó la interfaz y la experiencia de usuario basándose en lo aprendido en las fases anteriores, asegurando que el diseño sea intuitivo, accesible y alineado con los objetivos del proyecto. En el Capítulo V, se documentó el proceso de implementación y despliegue de la landing page de Electrolink. Se configuró el entorno de desarrollo, el control de versiones con Git, la guía de estilos del código y la estrategia de despliegue. Durante la ejecución del Sprint 1, se planificaron las tareas clave, se definieron roles y responsables, se construyó el backlog, y se generaron evidencias de desarrollo, ejecución, documentación de servicios y despliegue. Además, se reflexionó sobre el trabajo colaborativo del equipo, destacando los aprendizajes y retos enfrentados durante el ciclo de desarrollo.  |
|  |  |  |
|  |  |  |
|  |  |  |
|  |  |  |
...
| US-02 | Registro de cuentas como Dueño de Empresa | Como dueño o representante de empresa, quiero poder registrarme para tener una cuenta en la aplicación, para gestionar los componentes eléctricos de mis instalaciones comerciales | Escenario: Acceso a la sección de registro Given que el usuario no se encuentra registrado When navega a la aplicación And hace clic en la opción "Iniciar Sesión" o "Crear cuenta" Then es dirigido a la sección de registro And puede ver el formulario de registro completo And el formulario contiene todos los campos necesarios para crear una cuenta Escenario: Selección de tipo de usuario Given que el usuario no registrado accede a la página de registro When visualiza las opciones de tipo de usuario And selecciona "Dueño de Empresa" Then se muestra el formulario específico para dueños de empresas And los campos relevantes para este tipo de usuario son presentados Escenario: Registro exitoso con datos válidos Given que el usuario no registrado When accede a la página de registro And selecciona "Dueño de Empresa" And completa todos los campos obligatorios con información válida And hace clic en el botón "Registrarse" Then el sistema crea cuenta de usuario And el usuario es redirigido a una página de confirmación |  |  |  | 1 |
| US-03 | Registro de cuentas para Proveedores | Como proveedor de componentes eléctricos y/o servicios, quiero poder registrarme para tener una cuenta en la aplicación, para ofrecer mis productos y servicios a los usuarios  | Escenario: Acceso a la sección de registro Given que el usuario no se encuentra registrado When navega a la aplicación And hace clic en la opción "Iniciar Sesión" o "Crear cuenta" Then es dirigido a la sección de registro And puede ver el formulario de registro completo And el formulario contiene todos los campos necesarios para crear una cuenta Escenario: Selección de tipo de usuario Given que el usuario no registrado accede a la página de registro When visualiza las opciones de tipo de usuario And selecciona "Proveedor" Then se muestra el formulario específico para proveedores And los campos relevantes para este tipo de usuario son presentados Escenario: Registro exitoso con datos válidos Given que el usuario no registrado When accede a la página de registro And selecciona "Proveedor" And completa todos los campos obligatorios con información válida And hace clic en el botón "Registrarse" Then el sistema crea cuenta de usuario And el usuario es redirigido a una página de confirmación And se informa que la cuenta está pendiente de verificación administrativa  |  |  |  | 1 |
| US-04 | Validación de datos de registro | Como usuario, quiero recibir retroalimentación inmediata sobre la validez de los datos que ingresó durante el registro para corregir errores rápidamente. | Escenario \#1: Validación de formato de correo electrónico Given que el usuario se encuentra en el formulario de registro. When ingresa un texto en el campo de correo electrónico. And el texto no tiene formato de correo electrónico válido. Then ve un mensaje de error indicando "Por favor, ingrese un correo electrónico válido". And el campo se resalta en color rojo. Escenario \#2: Validación de correo electrónico ya registrado Given que estoy en el formulario de registro When ingreso un correo electrónico que ya está registrado en el sistema And cambio a otro campo Then veo un mensaje de error indicando "Este correo electrónico ya está en uso" And el campo se resalta en color rojo Escenario \#3: Validación de fortaleza de contraseña Given que el usuario se encuentra en el formulario de registro When ingresa el texto en el campo de contraseña And ve un indicador de fortaleza de contraseña en tiempo real Then ve recomendaciones sobre cómo mejorar la seguridad de la contraseña When no puede completar el registro si la contraseña no cumple con los requisitos mínimos Escenario \#4: Validación de coincidencia de contraseñas Given que el usuario se encuentra en el formulario de registro When ingresa contraseñas diferentes en los campos "Contraseña" y "Confirmar contraseña" Then veo un mensaje de error indicando "Las contraseñas no coinciden" And los campos se resaltan en color rojo Escenario \#5: Validación de campos obligatorios Given que el usuario se encuentra en el formulario de registro When intenta enviar el formulario dejando campos obligatorios en blanco Then el usuario ve mensajes de error junto a cada campo obligatorio vacío And no puede completar el registro |  |  |  | 1 |
| US-05 | Verificación de cuenta por correo electrónico | Como usuario, quiero verificar mi cuenta a través de un enlace enviado por correo electrónico para confirmar mi identidad. | Escenario \#1: Envío de correo de verificación Given que el usuario se ha registrado exitosamente When completó el proceso de registro Then recibo un correo electrónico de verificación And el correo contiene el nombre del usuario And el correo contiene un enlace único de verificación And el correo contiene instrucciones claras sobre cómo verificar mi cuenta Escenario \#2: Verificación exitosa de cuenta Given que el usuario ha recibido un correo electrónico de verificación When hace clic en el enlace de verificación Then su cuenta es verificada en el sistema And es redirigido a una página de confirmación And observa un mensaje indicando que mi cuenta ha sido verificada exitosamente And puede iniciar sesión con mis credenciales Escenario \#3: Intento de inicio de sesión sin verificación Given que el usuario se ha registrado pero no he verificado mi cuenta When intento iniciar sesión con mis credenciales Then veo un mensaje indicando que debo verificar mi cuenta And veo una opción para reenviar el correo de verificación Escenario \#4: Reenvío de correo de verificación Given que el usuario se ha registrado pero no he recibido o ha perdido el correo de verificación When solicita reenviar el correo de verificación Then recibe un nuevo correo electrónico de verificación And el enlace anterior queda invalidado Escenario \#5: Enlace de verificación expirado Given que el usuario ha recibido un correo electrónico de verificación When hace clic en el enlace después de que haya expirado (72 horas) Then observa un mensaje indicando que el enlace ha expirado And observa una opción para solicitar un nuevo enlace de verificación |  |  |  | 2 |
| US-06 | Mensajes de éxito retroalimentación de registro | Como usuario, quiero recibir mensajes claros y accesibles al completar el registro sobre éxito para entender fácilmente el resultado de mis acciones. | Escenario \#1: Mensaje de éxito al completar el registro Given que el usuario ha completado correctamente el formulario de registro When el sistema procesa mi solicitud con éxito Then observa un mensaje de confirmación que incluye: And el mensaje es claramente visible en la parte superior de la página And el mensaje tiene un color distintivo de éxito (verde) Escenario \#2: Mensaje informativo sobre la verificación por correo Given que el usuario ha completado exitosamente el registro When es redirigido a la página de confirmación Then observa información clara sobre: And la información es presentada en un formato fácil de leer |  |  |  | 1 |
| US-07 | Mensajes de error retroalimentación de registro | Como usuario, quiero recibir mensajes claros y accesibles al completar el registro sobre cualquier error a la hora de completar el formulario, para entender fácilmente el resultado de mis acciones y saber cómo proceder. | Escenario \#1: Mensaje de error por problemas del sistema Given que el usuario ha completado el formulario de registro When ocurre un error del sistema durante el procesamiento Then observa un mensaje de error que incluye: And el mensaje es claramente visible en la parte superior de la página And el mensaje tiene un color distintivo de error (rojo) And sus datos ingresados permanecen en el formulario |  |  |  | 1 |
| US-08 | Inicio de sesión de usuarios | Como usuario registrado, quiero poder iniciar sesión en la aplicación con mis credenciales para acceder a mi cuenta y utilizar las funcionalidades de la plataforma. | Escenario \#01: Acceso a la pantalla de inicio de sesión Given que el usuario se encuentra registrado When navega por la aplicación And hace clic en la opción "Iniciar Sesión" Then es dirigido a la pantalla de inicio de sesión And puede ver el formulario con campos para ingresar credenciales Escenario \#02: Inicio de sesión exitoso con credenciales válidas Given que el usuario se encuentra en la pantalla de inicio de sesión When ingresa su correo electrónico registrado And ingresa su contraseña correcta And hace clic en el botón "Iniciar Sesión" Then el sistema valida mis credenciales And es redirigido al dashboard correspondiente a mi tipo de usuario And puede ver mi información personal y opciones disponibles Escenario \#03: Intento de inicio de sesión con credenciales inválidas Given que el usuario se encuentra en la pantalla de inicio de sesión When ingresa un correo electrónico y/o contraseña incorrectos And hace clic en el botón "Iniciar Sesión" Then observa un mensaje de error indicando "Credenciales inválidas" And permanece en la pantalla de inicio de sesión And los campos del formulario se mantienen con la información ingresada excepto la contraseña Escenario \#04: Intento de inicio de sesión con cuenta no verificada Given que el usuario esta registrado pero no he verificado mi cuenta When ingresa mis credenciales correctas And hace clic en el botón "Iniciar Sesión" Then observa un mensaje indicando que mi cuenta requiere verificación And el sistema le ofrece la opción de reenviar el correo de verificación And no puede acceder a las funcionalidades de la aplicación Escenario \#05: Opción "Recordar usuario" en inicio de sesión Given que el usuario se encuentra en la pantalla de inicio de sesión When ha ingresado sus credenciales And marca la opción "Recordar usuario" And completa el inicio de sesión exitosamente Then en su próxima visita a la aplicación And su correo electrónico aparece pre-completado en el formulario de inicio de sesión Escenario \#06: Acceso al enlace de recuperación de contraseña Given que el usuario se encuentra en la pantalla de inicio de sesión When no recuerda mi contraseña Then puede ver un enlace "¿Olvidaste tu contraseña?" And al hacer clic en el enlace es dirigido a la funcionalidad de recuperación de contraseña  |  |  |  | 1 |
| US-09 | Recuperación de Contraseña | Como usuario registrado, quiero poder recuperar mi contraseña en caso de olvidarla, para poder volver a acceder a mi cuenta de manera segura. | Escenario \#01: Acceso a la funcionalidad de recuperación de contraseña Given que el usuario se encuentra registrado When accede a la pantalla de inicio de sesión And hace clic en el enlace "¿Olvidaste tu contraseña?" Then es dirigido a la página de recuperación de contraseña And puede ver un formulario para solicitar la recuperación Escenario \#02: Solicitud de recuperación con correo válido Given que el usuario se encuentra en la página de recuperación de contraseña When ingresa el correo electrónico asociado a mi cuenta And hace clic en el botón "Enviar instrucciones" Then el sistema envía un correo con instrucciones de recuperación And observa un mensaje de confirmación indicando que revise su correo And el mensaje incluye instrucciones sobre qué hacer si no recibe el correo Escenario \#03: Correo de recuperación con enlace de restablecimiento Given que el usuario se encuentra en la página de recuperación de contraseña When recibe el correo electrónico de recuperación Then el correo contiene un enlace único y seguro para restablecer su contraseña And el correo incluye información sobre tiempo de expiración del enlace And el enlace le dirige a una página para establecer una nueva contraseña Escenario \#05: Finalización exitosa del restablecimiento de contraseña Given que el usuario se encuentra en la página de restablecimiento When ingresa y confirma una nueva contraseña válida And hace clic en el botón "Guardar nueva contraseña" Then su contraseña es actualizada en el sistema And recibe un mensaje de confirmación del cambio exitoso And es dirigido a la página de inicio de sesión para acceder con su nueva contraseña Escenario \#06: Intento de restablecimiento con enlace expirado Given que el usuario ha recibido un correo de recuperación When hace clic en el enlace después de que haya expirado (24 horas) Then observa un mensaje indicando que el enlace ha expirado And se le ofrece la opción de solicitar un nuevo enlace de recuperación And no puede restablecer mi contraseña con este enlace Escenario \#07: Nueva contraseña que no cumple requisitos de seguridad Given que el usuario se encuentra en la página de restablecimiento When ingresa una nueva contraseña que no cumple los requisitos mínimos de seguridad And intenta guardarla Then observa mensajes de error indicando los requisitos de la contraseña And no se actualiza su contraseña hasta que cumpla con los requisitos |  |  |  | 2 |
| US | Cierre de Sesión | Como usuario autenticado, quiero cerrar mi sesión de forma segura para proteger mi cuenta cuando termine de usar la aplicación.  | Escenario \#1: Cierre de sesión desde cualquier pantalla Given que el usuario está autenticado en la aplicación When hace clic en la opción "Cerrar sesión" desde el menú de usuario Then su sesión es terminada de forma segura And es redirigido a la página de inicio de sesión And observa un mensaje confirmando que he cerrado sesión exitosamente Escenario \#2: Intento de acceso a páginas protegidas después del cierre de sesión Given que el usuario ha cerrado su sesión When intenta acceder directamente a una URL que requiere autenticación Then es redirigido a la página de inicio de sesión And observa un mensaje indicando que debe iniciar sesión para acceder Escenario \#3: Cierre de sesión por inactividad Given que el usuario se encuentra autenticado When permanece inactivo en la aplicación por un periodo prolongado (80 días) Then su sesión es cerrada automáticamente por seguridad And al intentar realizar una acción, es redirigido a la página de inicio de sesión And observa un mensaje indicando que mi sesión expiró por inactividad |  |  |  | 2 |
| US-11 | Visualización de Perfil de Propietario | Como propietario registrado , quiero poder visualizar mi perfil , para revisar mi información personal y preferencias almacenadas en el sistema | Escenario: Acceso a la sección de perfil Given que soy un usuario autenticado When hago clic en la opción "Mi Perfil" o mi nombre/avatar en la barra de navegación Then soy dirigido a la página de visualización de mi perfil And puedo ver toda mi información personal actual And puedo ver mis preferencias configuradasEscenario: Visualización de información personal para propietario de hogar Given que soy un propietario de hogar autenticado When accedo a mi perfil Then puedo ver la siguiente información Escenario: Visualización de información personal para propietario de empresa Given que soy un propietario de empresa autenticado When accedo a mi perfil Then puedo ver la siguiente información Escenario: Visualización de historial de servicios solicitados Given que soy un propietario autenticado (hogar o empresa) When accedo a mi perfil Then puedo ver una sección de "Historial de Servicios" And puedo ver una lista de los servicios que he solicitado And para cada servicio puedo ver fecha, tipo de servicio, proveedor y estado |  |  |  | 3 |
| US-12 | Edición de Perfil de Propietario | Como propietario registrado ,quiero poder editar mi información personal y preferencias , para mantener mi perfil actualizado y tener más control sobre este. | Escenario: Acceso a la opción de edición de perfil Given que el usuario esta visualizando mi perfil When hace clic en el botón "Editar Perfil" Then se habilitan los campos editables de su perfil And puede modificar su información personal Escenario: Edición exitosa de información básica Given que el usuario está en modo de edición de perfil When modificar mi información personal (teléfono, dirección, etc.) And hace clic en "Guardar Cambios" Then sus cambios se almacenan en el sistema And observa un mensaje de confirmación And visualiza su perfil actualizado Escenario: Edición de información no permitida Given que el usuario está en modo de edición de perfil When intenta modificar información no editable (correo electrónico registrado, tipo de usuario) Then estos campos aparecen deshabilitados o como solo lectura And observa una nota explicando que esta información no puede ser modificada directamente Escenario: Cambio de contraseña desde el perfil Given que el usuario se encuentra en modo de edición de perfil When seleccione la opción "Cambiar Contraseña" Then se le solicita ingresar su contraseña actual And se le solicita ingresar y confirmar la nueva contraseña And al completar correctamente, su contraseña es actualizada Escenario: Actualización de preferencias de notificaciones Given que el usuario está en modo de edición de perfil When accede a la sección "Preferencias de Notificaciones" Then puede configurar qué notificaciones desea recibir And puede elegir los canales de comunicación (correo, SMS, push) And sus preferencias se guardan al hacer clic en "Guardar" Escenario: Carga de nueva foto de perfil/logo Given que el usuario está en modo de edición de perfil When hace clic en la opción para cambiar mi foto de perfil o logo Then puede seleccionar una nueva imagen desde su dispositivo And puede recortar/ajustar la imagen And al confirmar, la nueva imagen se establece como sus foto de perfil/logo |  |  |  | 3 |
| US-13 | Visualización de Perfil de Proveedor | Como proveedor registrado Quiero poder visualizar mi perfil profesional Para revisar cómo se presenta mi información y servicios a los clientes potenciales | Escenario: Acceso a la visualización del perfil Given que el proveedor se encuentra autenticado When hace clic en la opción "Mi Perfil" o su nombre/avatar en la barra de navegación Then es dirigido a la página de visualización de su perfil profesional And puede ver toda su información como aparece para los clientes   Escenario: Visualización de información profesional Given que el proveedor se encuentra autenticado When accede a mi perfil Then puede ver la siguiente información   Escenario: Visualización de certificaciones Given que el proveedor se encuentra autenticado When accede a su perfil Then puede ver una sección de "Certificaciones" And puede ver todas las certificaciones que ha subido And puede ver el estado de verificación de cada certificación   Escenario: Visualización de reseñas recibidas Given que el proveedor se encuentra autenticado When accede a mi perfil Then puede ver una sección de "Reseñas y Calificaciones" And puede ver todas las reseñas dejadas por clientes anteriores And puede ver la calificación individual y promedio |  |  |  | 3 |
| US-14 | Edición de Perfil de Proveedor | Como proveedor registrado, quiero poder editar mi información profesional, certificaciones y servicios ofrecidos para mantener mi perfil actualizado y atractivo para los clientes. | Escenario: Acceso a la edición del perfil Given que el usuario se encuentra visualizando su perfil de proveedor When hace clic en el botón "Editar Perfil" Then se habilitan las secciones editables de su perfil profesional And puede modificar su información   Escenario: Actualización de información básica Given que el usuario se encuentra en modo de edición de perfil When modifica su información básica (descripción, contacto, etc.) And hace clic en "Guardar Cambios" Then sus cambios se almacenan en el sistema And observa un mensaje de confirmación And visualiza su perfil actualizado   Escenario: Gestión de servicios ofrecidos Given que el usuario se encuentra en modo de edición de perfil When accede a la sección "Servicios Ofrecidos" Then puede añadir nuevos servicios de una lista predefinida And puede eliminar servicios que ya no ofrece And puede actualizar descripciones o precios de referencia   Escenario: Carga de nuevas certificaciones Given que el usuario se encuentra en modo de edición de perfil When accede a la sección "Certificaciones" And hace clic en "Añadir Certificación" Then puede subir un archivo de certificación And puede agregar detalles como institución, fecha y descripción And la certificación queda marcada como "Pendiente de verificación"   Escenario: Actualización del portafolio de trabajos Given que el usuario se encuentra en modo de edición de perfil When accede a la sección "Portafolio" Then puede añadir nuevas imágenes o ejemplos de trabajos realizados  |  |  |  | 4 |
| Us-15 | Gestión de Disponibilidad de Proveedor | Como proveedor Quiero poder gestionar mi disponibilidad horaria y calendario Para que los clientes puedan solicitar mis servicios en horarios en que estoy disponible | Escenario: Acceso a la gestión de disponibilidad Given que el proveedor se encuentra autenticado When accede a la sección "Mi Disponibilidad" dentro de su perfil Then puede ver un calendario con mi disponibilidad actual And puede ver una vista general de mis horarios disponibles   Escenario: Configuración de horario regular Given que el usuario se encuentra en la sección "Mi Disponibilidad" When selecciona la opción "Configurar Horario Regular" Then puede establecer sus horas disponibles para cada día de la semana And puede marcar días completos como no disponibles And sus cambios se guardan al hacer clic en "Guardar Configuración"   Escenario: Bloqueo de fechas específicas Given que el usuario se encuentra en la sección "Mi Disponibilidad" When selecciona fechas específicas en el calendario And marca estas fechas como "No Disponible" Then estas fechas se bloquean en su calendario And los clientes no pueden solicitar servicios en estas fechas   Escenario: Configuración de tiempos de desplazamiento Given que el usuario se encuentra en la sección "Mi Disponibilidad" When configura sus "Tiempos de Desplazamiento". Then puede establecer el tiempo estimado entre servicios. And el sistema considera estos tiempos al mostrar su disponibilidad. And evita solapamientos en las solicitudes de servicio. |  |  |  | 6 |
| US-16 | Mensajes de éxito de actualización de perfil | Como usuario, quiero recibir mensajes claros y accesibles al completar la actualización de perfil sobre éxito para entender fácilmente el resultado de mis acciones. | Escenario \#1: Mensaje de éxito al completar el registro Given que el usuario ha completado correctamente el formulario de registro When el sistema procesa mi solicitud con éxito Then observa un mensaje de confirmación que incluye: And el mensaje es claramente visible en la parte superior de la página And el mensaje tiene un color distintivo de éxito (verde)  Escenario \#3: Mensaje informativo sobre la verificación por correo Given que el usuario ha completado exitosamente el registro When es redirigido a la página de confirmación Then observa información clara sobre: And la información es presentada en un formato fácil de leer |  |  |  | 3 |
| US-17 | Mensajes de error de actualización de perfil | Como usuario, quiero recibir mensajes claros y accesibles al completar el registro sobre cualquier error a la hora de completar el formulario, para entender fácilmente el resultado de mis acciones y saber cómo proceder. | Escenario \#1: Mensaje de error por problemas del sistema Given que el usuario ha completado el formulario de registro When ocurre un error del sistema durante el procesamiento Then observa un mensaje de error que incluye: And el mensaje es claramente visible en la parte superior de la página And el mensaje tiene un color distintivo de error (rojo) And sus datos ingresados permanecen en el formulario |  |  |  | 3 |
| US-18 | Búsqueda por Ubicación y Tipo de Servicio | Como usuario, quiero poder buscar servicios filtrando por ubicación y tipo de servicio, para encontrar rápidamente los que se ajustan a mis necesidades específicas. | Escenario \#1: Búsqueda básica por ubicación  Given que el propietario se encuentra en la página principal de búsqueda  When introduce una ubicación (ciudad, barrio, código postal)  And selecciona un tipo de servicio de la lista desplegable And hago clic en "Buscar"  Then el sistema muestra resultados que coinciden con ambos criterios And puede observar la distancia de cada resultado respecto a la ubicación indicada   Escenario \#2: Búsqueda con múltiples filtros  Given que el propietario se encuentra en la página de resultados de búsqueda  When selecciona filtros adicionales (rango de precios, disponibilidad, valoración mínima)  Then los resultados se actualizan automáticamente  And solo se muestran los servicios que cumplen con todos los criterios seleccionados   Escenario \#3: Guardar filtros favoritos  Given el propietario ha configurado varios filtros para mi búsqueda  When hace clic en "Guardar esta búsqueda"  And asigna un nombre a la configuración de búsqueda  Then puede acceder a esta configuración de filtros en el futuro  And puede recibir notificaciones cuando haya nuevos servicios que coincidan con mis filtros guardados |  |  |  | 4 |
| US-19 | Búsqueda Geolocalizada | Como usuario, quiero buscar servicios cerca de mi ubicación actual, para encontrar opciones convenientes sin necesidad de introducir manualmente mi ubicación. | Escenario \#1: Activación de geolocalización Given que el usuario se encuentra en la plataforma When hago clic en el botón "Cerca de mí" Then se me solicita permiso para acceder a mi ubicación And al otorgar permiso, la aplicación detecta automáticamente mi posición actual Escenario \#2: Visualización de resultados por proximidad Given que he compartido mi ubicación con la plataforma When realizó una búsqueda Then los resultados se ordenan por cercanía a mi posición actual And puedo ver la distancia real hasta cada servicio And puedo abrir rutas en mi aplicación de mapas preferida Escenario \#3: Ajuste del radio de búsqueda Given que estoy utilizando la búsqueda geolocalizada When ajusto el control deslizante de distancia máxima Then los resultados se actualizan para mostrar solo servicios dentro del radio seleccionado And puedo ver en un mapa la zona de cobertura de mi búsqueda |  |  |  | 4 |
| US-20 | Filtrado por Disponibilidad y Calificación | Como usuario, quiero filtrar servicios por su disponibilidad horaria y calificación promedio, para encontrar servicios bien valorados que se ajusten a mi agenda. | Escenario \#1: Filtrado por disponibilidad  Given que estoy en la página de búsqueda  When selecciono fechas específicas en el calendario  And elijo rangos horarios que me convienen  Then solo se muestran servicios disponibles en esos momentos  And puedo ver claramente los horarios disponibles para cada resultado   Escenario \#2: Filtrado por calificación mínima  Given que estoy en la página de resultados de búsqueda  When ajusto el filtro de calificación mínima a 4 estrellas  Then solo se muestran servicios con una calificación promedio igual o superior a 4 estrellas  And puedo ver el número de reseñas en las que se basa cada calificación   Escenario \#3: Combinación de filtros de disponibilidad y calificación  Given que he aplicado filtros de disponibilidad  When además seleccionó un filtro de calificación mínima  Then los resultados muestran solo servicios que cumplen con ambos criterios  And puedo ajustar los filtros independientemente sin perder los otros criterios |  |  |  | 4 |
| US-21 | Sistema de Calificación Post-Servicio | Como usuario, quiero poder calificar y dejar reseñas sobre los servicios que he utilizado, para compartir mi experiencia con otros usuarios y proporcionar retroalimentación a los proveedores. | Escenario \#1: Habilitación de calificación tras usar un servicio Given que he completado un servicio verificado por el sistema When accedo a la sección "Mis Servicios" o al perfil del proveedor utilizado Then veo una opción para "Calificar este servicio" And puedo asignar una puntuación de 1 a 5 estrellas And puedo escribir una reseña detallada   Escenario \#2: Intento de calificación sin haber usado el servicio Given que estoy navegando por un perfil de servicio que no he utilizado When intento acceder a la función de calificación Then se me muestra un mensaje indicando que solo puedo calificar servicios que he utilizado And se me sugiere reservar el servicio si estoy interesado   Escenario \#3: Edición de una reseña existente Given que he dejado una calificación previa para un servicio When accedo a mi reseña y seleccione "Editar" Then puedo modificar mi puntuación y comentario And los cambios se guardan con una marca de "Editado" y la fecha de modificación |  |  |  | 7 |
| US-22 | Visualización de Calificaciones y Reseñas | Como usuario, quiero poder ver las calificaciones y reseñas dejadas por otros usuarios, para tomar decisiones informadas sobre qué servicios utilizar. | Escenario \#1: Vista general de calificaciones Given que estoy viendo el perfil de un servicio Then puedo ver su calificación promedio And puedo ver un desglose por número de estrellas (cuántas reseñas de 5 estrellas, cuántas de 4, etc.) And puedo ver el número total de reseñas   Escenario \#2: Lectura de reseñas detalladas Given que estoy en la sección de reseñas de un servicio When desplazo hacia abajo Then puedo leer todas las reseñas textuales dejadas por otros usuarios And puedo ver la fecha de cada reseña And puedo filtrar las reseñas por puntuación o fecha   Escenario \#3: Visualización de respuestas del proveedor Given que estoy leyendo reseñas de un servicio When el proveedor ha respondido a alguna de las reseñas Then puedo ver tanto la reseña original como la respuesta del proveedor And puedo identificar claramente qué contenido pertenece a cada parte   Escenario \#4: Reporte de reseñas inapropiadas Given que estoy leyendo reseñas de un servicio When encuentro una reseña que considero inapropiada o falsa Then puedo hacer clic en "Reportar" And puedo seleccionar el motivo de mi reporte And recibo confirmación de que mi reporte será revisado por moderadores |  |  |  | 4 |
| US-23 | Contratación de Servicios Eléctricos mediante Wizard | Como propietario de PyME, quiero contar con un proceso guiado paso a paso para contratar servicios eléctricos, para poder solucionar mis problemas de forma rápida y sin complicaciones. | Escenario \#1: Selección del tipo de problema eléctrico Given que estoy en la sección de contratación de servicios When inicio el proceso haciendo clic en "Contratar Servicio Eléctrico" Then se me presenta un formulario tipo wizard con pasos secuenciales And el primer paso me permite seleccionar el tipo de problema de una lista categorizada And puedo añadir descripción detallada y fotos del problema   Escenario \#2: Elección de técnico disponible Given que he seleccionado y descrito mi problema eléctrico When avanzo al siguiente paso del wizard Then veo una lista de técnicos disponibles para resolver mi problema And puedo filtrar por valoración, precio y disponibilidad And puedo ver el perfil completo de cada técnico antes de decidir   Escenario \#3: Selección de fecha y horario Given que he seleccionado un técnico para mi servicio When paso a la etapa de programación Then puedo ver un calendario con las fechas y horarios disponibles And puedo seleccionar la franja horaria que mejor se adapte a mi disponibilidad And recibo recomendaciones de horarios con menor tarifa si aplica   Escenario \#4: Confirmación y pago del servicio Given que he seleccionado problema, técnico y fecha When llego al paso final del wizard Then veo un resumen completo de mi solicitud con todos los detalles And se me presenta un desglose de costos (visita técnica, materiales estimados, etc.) And puedo seleccionar un método de pago And al confirmar, recibo una confirmación por correo electrónico y en la aplicación  |  |  |  | 4 |
| US-24 | Entrar a un dashboard Personalizado | Como usuario de la plataforma, quiero acceder a un dashboard personalizado al iniciar sesión, para visualizar de forma inmediata la información relevante según mi rol y actividad reciente. | Escenario: Visualización del dashboard para cliente Given que he iniciado sesión como cliente (propietario/PyME) When accedo a la página principal Then veo un resumen de mis servicios activos And veo mis próximos mantenimientos programados And veo notificaciones recientes y recordatorios And veo recomendaciones personalizadas de servicios y guías   Escenario: Visualización del dashboard para técnico/proveedor Given que he iniciado sesión como proveedor When accedo a la página principal Then veo mi agenda de servicios del día And veo las solicitudes pendientes que requieren mi atención And veo un resumen de mis ingresos y estadísticas recientes And veo mis calificaciones recientes y alertas importantes |  |  |  | 3 |
| US-25 | Centro de Notificaciones | Como usuario de la plataforma, quiero acceder a un centro centralizado de notificaciones, para estar al tanto de actualizaciones importantes y no perder información relevante. | Como usuario de la plataforma, quiero acceder a un centro centralizado de notificaciones, para estar al tanto de actualizaciones importantes y no perder información relevante. Escenario: Visualización de notificaciones no leídas Given que he iniciado sesión en la plataforma When hago clic en el icono de notificaciones Then veo un listado de notificaciones recientes con las no leídas destacadas And puedo ver la cantidad de notificaciones no leídas And puedo marcar todas como leídas con un solo clic   Escenario: Filtrado de notificaciones Given que estoy en el centro de notificaciones When selecciono un filtro específico (servicios, pagos, sistema) Then las notificaciones se filtran según mi selección And puedo buscar notificaciones específicas por palabra clave   Escenario: Acciones desde notificaciones Given que estoy viendo una notificación específica When hago clic en ella Then soy redirigido a la sección relacionada con la notificación And puedo realizar acciones directas si la notificación lo requiere And la notificación se marca automáticamente como leída |  |  |  | 3 |
| US-26 | Sistema de Soporte al Usuario | Como usuario de la plataforma, quiero acceder a un sistema de soporte integrado, para resolver dudas o problemas técnicos que pueda tener durante mi experiencia. | Escenario: Consulta de base de conocimientos Given que estoy en la sección "Soporte" When busco en la base de conocimientos usando palabras clave Then veo artículos y tutoriales relacionados con mi búsqueda And puedo filtrar por categorías específicas And puedo calificar la utilidad de los artículos consultados   Escenario: Acceso a chat en vivo Given que estoy en la sección "Soporte" When el soporte en vivo está disponible según el horario indicado Then puedo iniciar una conversación con un agente de soporte And puedo compartir capturas de pantalla de mi problema And recibo un registro de la conversación por correo electrónico al finalizar |  |  |  | 7 |
| US-27 | Gestión de Técnicos Favoritos | Como cliente, quiero poder marcar y gestionar una lista de técnicos favoritos, para contactarlos fácilmente para futuros servicios y dar preferencia a aquellos con los que he tenido buenas experiencias. | Como cliente, quiero poder marcar y gestionar una lista de técnicos favoritos, para contactarlos fácilmente para futuros servicios y dar preferencia a aquellos con los que he tenido buenas experiencias. Escenario: Añadir técnico a favoritos Given que he recibido un servicio satisfactorio de un técnico When visito su perfil profesional And hago clic en "Añadir a favoritos" Then el técnico se añade a mi lista de favoritos And recibo confirmación de la acción   Escenario: Visualización de lista de favoritos Given que he marcado varios técnicos como favoritos When accedo a la sección "Técnicos Favoritos" Then veo un listado de todos mis técnicos favoritos And puedo filtrarlos por especialidad And veo su disponibilidad actual y datos de contacto   Escenario: Contratación directa de favoritos Given que estoy en mi lista de técnicos favoritos When selecciono "Contratar servicio" en un técnico específico Then se inicia el wizard de contratación con ese técnico preseleccionado And puedo omitir el paso de selección de técnico And el técnico recibe notificación prioritaria de mi solicitud |  |  |  | 3 |
| US-28 | Sistema de Recomendaciones Personalizadas | Como cliente, quiero recibir recomendaciones personalizadas de servicios y productos basados en mi historial y necesidades, para descubrir soluciones relevantes que puedan mejorar mi experiencia. | Escenario: Visualización de recomendaciones en dashboard Given que he iniciado sesión en mi cuenta When accedo a la sección "Recomendaciones" en mi panel Then veo sugerencias de servicios basados en mis contrataciones previas And veo productos relacionados con mis instalaciones   Escenario: Ajuste de preferencias de recomendación Given que estoy en la sección de recomendaciones When selecciono "Configurar preferencias" Then puedo indicar qué tipos de recomendaciones deseo recibir And puedo establecer un presupuesto máximo para recomendaciones And mis preferencias se aplican a futuras sugerencias |  |  |  | 7 |
| US-29 | Gestión de Pagos y Facturación | Como cliente, quiero gestionar mis pagos y acceder a mi historial de facturación, para mantener control sobre mis gastos y tener la documentación necesaria para fines contables. | Escenario: Visualización de facturas pendientes Given que he iniciado sesión en mi cuenta When accedo a la sección "Pagos" Then veo un listado de facturas pendientes de pago And puedo ver el detalle de cada factura And puedo seleccionar varias facturas para pago conjunto   Escenario: Descarga de comprobantes fiscales Given que estoy en la sección "Pagos" When selecciono una factura pagada Then puedo descargar el comprobante fiscal (PDF) And puedo solicitar el envío del comprobante por correo And puedo ver el historial completo de facturas emitidas   Escenario: Configuración de facturación automática Given que estoy en la sección "Pagos" When configuro "Facturación automática" Then puedo establecer un método de pago predeterminado And puedo activar el pago automático para servicios recurrentes And recibo notificaciones previas antes de cada cargo |  |  |  | 7 |
| US-30 | Gestión de Agenda y Citas | Como técnico/proveedor, quiero poder gestionar mi agenda de servicios y citas, para organizar eficientemente mi trabajo y maximizar mi productividad. | Como técnico/proveedor, quiero poder gestionar mi agenda de servicios y citas, para organizar eficientemente mi trabajo y maximizar mi productividadEscenario: Visualización de agenda diaria/semanal/mensual Given que he iniciado sesión como proveedor When accedo a "Agenda de Servicios" Then puedo alternar entre vistas diaria, semanal y mensual And veo claramente mis servicios programados con códigos de color And puedo ver detalles rápidos al pasar el cursor sobre cada cita   Escenario: Confirmación de citas pendientes Given que tengo solicitudes de servicio pendientes When accedo a mi panel de citas Then puedo ver las solicitudes que requieren confirmación And puedo aceptar, reprogramar o rechazar cada solicitud And al tomar una acción, el cliente recibe notificación automática   Escenario: Bloqueo de horarios no disponibles Given que estoy en mi agenda de servicios When selecciono "Bloquear horario" Then puedo marcar franjas horarias como no disponibles And puedo establecer motivos (personal, otro trabajo, descanso) And estos horarios no aparecen como disponibles para los clientes   Escenario: Gestión de tiempos de traslado Given que estoy configurando mi agenda When activo "Considerar tiempos de traslado" Then el sistema calcula automáticamente tiempos entre servicios And sugiere horarios factibles basados en ubicaciones geográficas And me advierte de posibles conflictos por distancias excesivas |  |  |  | 6 |
| US-31 | Gestión de Planes y Suscripciones | Como proveedor, quiero poder gestionar mi plan de suscripción en la plataforma, para acceder a beneficios adicionales que me ayuden a crecer mi negocio. | Escenario: Visualización de planes disponibles Given que estoy en la sección "Mi Suscripción" When selecciono "Ver planes disponibles" Then veo una comparativa de todos los planes (gratuito y premium) And puedo ver claramente los beneficios adicionales de cada plan And veo el precio y período de facturación de cada opción   Escenario: Actualización a plan premium Given que tengo un plan gratuito When selecciono actualizar a un plan premium Then veo un resumen de los nuevos beneficios que obtendré And puedo seleccionar un método de pago And tras completar el pago, mi cuenta se actualiza inmediatamente And recibo confirmación por correo electrónico   Escenario: Gestión de facturación de suscripción Given que tengo un plan de pago activo When accedo a "Detalles de facturación" Then puedo ver mi historial de pagos de suscripción And puedo actualizar mi método de pago And puedo descargar comprobantes fiscales de mis pagos   Escenario: Cancelación o downgrade de plan Given que tengo un plan premium activo When selecciono "Cancelar" o "Cambiar plan" Then veo información sobre cómo afectará a mis servicios And se me muestra el período restante de beneficios premium And puedo confirmar o cancelar la acción |  |  |  | 6 |
| US-32 | Gestión de Servicios Ofrecidos | Como proveedor, quiero poder gestionar mi catálogo de servicios ofrecidos, para mantenerlo actualizado y mostrar claramente a los clientes mi oferta y especialidades | Escenario: Creación de nuevo servicio Given que estoy en la sección "Productos/Catálogo" When selecciono "Añadir nuevo servicio" Then puedo completar un formulario detallado (nombre, descripción, categoría) And puedo establecer precios base o rangos de precio estimado And puedo indicar materiales incluidos/no incluidos And puedo subir fotos de trabajos anteriores como referencia   Escenario: Edición de servicios existentes Given que tengo servicios publicados When selecciono un servicio específico para editar Then puedo modificar cualquier aspecto del servicio And los cambios se reflejan inmediatamente en mi perfil público And los clientes con servicios pendientes reciben notificación si es relevante   Escenario: Configuración de disponibilidad por servicio Given que estoy editando mis servicios When configuro "Disponibilidad específica" Then puedo establecer horarios específicos para cada tipo de servicio And puedo limitar el número de servicios de cada tipo por día/semana And puedo establecer zonas geográficas de cobertura por servicio   Escenario: Establecimiento de promociones temporales Given que estoy en la gestión de servicios When selecciono "Crear promoción" Then puedo seleccionar servicios específicos para promocionar And puedo establecer descuentos o beneficios adicionales And puedo definir un período de validez para la promoción And la promoción se destaca automáticamente en mi perfil |  |  |  | 6 |
| US-33 | Historial de Clientes Atendidos | Como proveedor, quiero acceder a un historial detallado de los clientes que he atendido, para dar seguimiento a relaciones profesionales y mejorar mi servicio basado en experiencias previas. | Escenario: Visualización de historial de clientes Given que he iniciado sesión como proveedor When accedo a "Historial de Clientes" Then veo un listado de todos los clientes que he atendido And puedo filtrar por fecha, tipo de servicio o ubicación And puedo buscar clientes específicos por nombre   Escenario: Acceso a detalles de cliente específico Given que estoy en el historial de clientes When selecciono un cliente específico Then accedo a su perfil detallado dentro de mi panel And veo todos los servicios que le he proporcionado And veo las calificaciones y comentarios que me ha dejado And veo notas privadas que he guardado sobre este cliente   Escenario: Seguimiento post-servicio Given que he completado un servicio recientemente When accedo al perfil del cliente correspondiente Then puedo enviar un mensaje de seguimiento personalizado And puedo ofrecer un descuento en su próximo servicio And puedo programar un recordatorio para contactarlo en el futuro   Escenario: Análisis de feedback de clientes Given que estoy en la sección de historial de clientes When selecciono "Análisis de feedback" Then veo estadísticas sobre la satisfacción de mis clientes And veo tendencias en comentarios positivos y negativos And recibo sugerencias sobre áreas de mejora basadas en el feedback |  |  |  | 6 |
| US-34 | Crear Portafolio Digital con Evidencias de Trabajo | Como proveedor de servicios eléctricos, quiero crear un portafolio digital dentro de mi perfil que incluya fotos, descripciones y referencias de trabajos anteriores, para mostrar mi experiencia y generar mayor confianza en potenciales clientes. | Given el proveedor ya tiene una cuenta activa en la plataforma And ha iniciado sesión correctamente When accede a la sección "Mi Portafolio" desde su perfil And selecciona la opción "Agregar nuevo trabajo" And sube una imagen, una descripción del trabajo y una referencia del cliente Then el sistema debe guardar y mostrar el nuevo trabajo en su portafolio And debe aparecer públicamente en su perfil visible para clientes And el proveedor debe poder editar o eliminar esa publicación en cualquier momento  |  |  |  | 6 |
| US-35 | Publicar Servicios en Foros de Contratación Certificada | Como proveedor certificado, quiero poder publicar mis servicios en espacios o foros donde se busca contratar profesionales verificados, para aumentar mi visibilidad y conseguir nuevas oportunidades laborales. | Given el proveedor tiene una cuenta verificada y está autenticado en la plataforma And ha completado su perfil incluyendo certificaciones y portafolio When accede a la sección "Foros de oportunidades" And selecciona la opción "Publicar servicio" And completa el formulario con detalles del servicio, zona de atención y disponibilidad Then su publicación debe aparecer en los foros visibles para usuarios que buscan contratar profesionales certificados And el sistema debe mostrar una insignia que verifique su condición de proveedor validado And debe poder editar o eliminar su publicación en cualquier momento  |  |  |  | 6 |
| US-36 | Solicitar Inspección General Anual | Como propietario responsable, quiero poder pedir una inspección general de mis instalaciones eléctricas una vez al año, para prevenir riesgos, fallas y garantizar el buen estado de mi sistema eléctrico. | Given el usuario tiene una cuenta activa como propietario And ha registrado una dirección o espacio para inspección en su perfil And no ha solicitado una inspección general en los últimos 10 meses When accede a la sección de "Mantenimientos preventivos" And selecciona la opción "Solicitar inspección general anual" And confirma la dirección y disponibilidad para la visita Then el sistema debe generar una orden de inspección preventiva And debe asignar un proveedor certificado disponible para la zona y tipo de servicio And mostrar la fecha y estado de la solicitud en el historial del usuario  |  |  |  | 4 |
| US-37 | Registrar Consumo Eléctrico Mensual | Como usuario interesado en el control energético, quiero poder anotar manualmente mi consumo mensual de electricidad, para llevar un seguimiento y detectar posibles aumentos o ahorros en el tiempo. | Given el usuario ha iniciado sesión en su cuenta And se encuentra en la sección de “Mi consumo eléctrico” When selecciona el mes actual And ingresa la cantidad de kWh consumidos según su medidor o factura And presiona “Guardar” Then el sistema debe almacenar ese dato en el historial mensual And mostrar un gráfico con la evolución del consumo en los últimos meses And sugerir consejos si hay un aumento significativo de consumo  |  |  |  | 4 |
| US-38 | Visualización de Características y Beneficios | Como visitante de la landing page,Quiero ver claramente las características y beneficios de la plataforma,Para entender cómo puede ayudarme y decidir si registrarme. | Escenario \#1: Visualización de beneficios para propietarios Given que un propietario potencia se encuentra visitando la landing page When se desplaza hasta la sección "Resolvemos problemas reales" Then deberá ver claramente los beneficios específicos para propietarios And cada beneficio debería tener un ícono representativo And una descripción breve y clara And los beneficios deberían ser visibles sin necesidad de hacer clic en ningún elemento Escenario \#2: Visualización de características principales Given que un visitante se encuentra de la landing page When se desplaza hasta la sección "Características principales" Then debería ver al menos 6 características destacadas de la plataforma And cada característica debería tener un título descriptivo And una explicación concisa de su funcionamiento And un ícono visual que represente la característica |  |  |  | 7 |
| US-39 | Visualización de Testimonios | Descripción HU:Como visitante indeciso sobre la plataforma,Quiero ver testimonios de usuarios reales,Para aumentar mi confianza en el servicio antes de registrarse. | Escenario \#1: Visualización de testimonios diversos Given que el visitante se encuentra en la landing page When se desplaza hasta la sección "Lo que dicen nuestros usuarios" Then debería ver al menos 3 testimonios diferentes And cada testimonio debería mostrar: Nombre de usuario, tipo de usuario , calificación y comentario. And observará testimonios tanto de propietarios como de proveedores And las calificaciones deberían ser visualmente claras (estrellas) Escenario \#2: Navegación entre testimonios en dispositivos móviles Given que el visitante se encuentra usando un dispositivo móvil When accede a la sección de testimonios Then podrá deslizar horizontalmente para ver todos los testimonios And verá indicadores de paginación que muestren cuántos testimonios hay disponibles And en qué testimonio me encuentro actualmente |  |  |  | 7 |
