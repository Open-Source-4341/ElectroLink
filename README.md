...
| US-37 | Registrar Consumo Eléctrico Mensual | Como usuario interesado en el control energético, quiero poder anotar manualmente mi consumo mensual de electricidad, para llevar un seguimiento y detectar posibles aumentos o ahorros en el tiempo. | Given el usuario ha iniciado sesión en su cuenta And se encuentra en la sección de “Mi consumo eléctrico” When selecciona el mes actuala And ingresa la cantidad de kWh consumidos según su medidor o factura And presiona “Guardar” Then el sistema debe almacenar ese dato en el historial mensual And mostrar un gráfico con la evolución del consumo en los últimos meses And sugerir consejos si hay un aumento significativo de consumo  | 4 |
