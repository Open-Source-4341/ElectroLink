...
| US-36 | Eliminación de Propiedad (Propietario) | Como propietario, quiero  eliminar una propiedad de mi cuenta, si ya no la gestiono. | Escenario #1: Eliminación de una propiedad<br>Dado que que un Propietario visualiza sus propiedades registradas<br>Cuando selecciona una propiedad y solicita su eliminación<br>Entonces el sistema solicita confirmación<br>Y elimina la propiedad de su cuenta tras la confirmación. | EP-10 |
