...
|-------------------------|--------------------------|------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Del Aguila Ayala, Ricardo Alejandro** | - Domain-Driven Software Architecture <br> - User Stories <br> - Capítulo V - Landing Page | Su comunicación técnica fue esencial para coordinar desde la arquitectura hasta la entrega. Supo traducir conceptos complejos en historias claras, facilitando una ejecución ordenada y alineada al objetivo del proyecto. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Sánchez Manrique, Italo Ludwing** | - User Persona <br> - Análisis de entrevistas <br> - Web Applications Wireflow Diagrams <br> - Style Guidelines <br> - Web Applications Prototyping | Destacó por su claridad al comunicar necesidades de usuarios y plasmarlas en entregables visuales. Facilitó decisiones de diseño efectivas y alineadas al enfoque centrado en el usuario. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Machado Bracamonte, Ivo Marcelo** | - Labeling Systems <br> - Landing Page UI Design <br> - Web Applications Mock-ups <br> - Web Applications Prototyping | Logró comunicar visualmente la estructura e identidad del producto. Su trabajo ayudó a mantener la coherencia de las interfaces y permitió una mejor interpretación por parte del equipo técnico. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Aliaga Aguirre, Ethan Matías** | - Software Object-Oriented Design <br> - Capítulo V - Landing Page | Contribuyó eficazmente en la traducción del diseño técnico en componentes funcionales. Mantuvo una comunicación técnica clara con el equipo, garantizando coherencia y funcionalidad en el desarrollo. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. <br> **Contreras Lopez, Leandro Saúl** | - Software Development Environment Configuration <br> - Product Backlog <br> - SEO Tags and Meta Tags | Fue clave en la planificación y base técnica del sistema. Su comunicación facilitó la integración del entorno de trabajo y una gestión efectiva del backlog con visión técnica y estratégica. |
