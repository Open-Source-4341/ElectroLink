...
|-------------------------|--------------------------|------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Del Aguila Ayala, Ricardo Alejandro**  <br> **TB1:** Trabajé en la arquitectura del software aplicando Domain-Driven Design. Redacté historias de usuario, lideré la implementación de la landing page y documenté técnicamente cada componente. <br> **TP:** Coordiné la documentación del Sprint 2, incluyendo el Sprint Planning, Backlog y evidencias técnicas. Me enfoqué en comunicar con precisión los avances del equipo en el repositorio y en mantener alineadas las entregas técnicas con los criterios definidos. <br> **TB2:** Me encargué de revisar la consistencia entre las evidencias y los criterios de validación. Redacté parte de las conclusiones y lideré la organización de entrevistas de validación, asegurando claridad en las instrucciones y en la interpretación de los hallazgos. | **TB1:** Mostró una capacidad sólida para comunicar temas técnicos complejos al equipo. <br> **TP:** Reflejó una comunicación efectiva en los entregables de Sprint, facilitando la organización del equipo en base a criterios claros y bien documentados. <br> **TB2:** Consolidó su capacidad de comunicación tanto técnica como con usuarios externos, guiando procesos de validación con precisión y enfoque analítico. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Sánchez Manrique, Italo Ludwing** <br> **TB1:** Participé en la elaboración de User Persona, diagramas de flujo y prototipos web. También contribuí en la guía de estilos asegurando coherencia visual. <br> **TP:** Lideré la implementación de funcionalidades en mi módulo del frontend. Documenté los endpoints usados y colaboré en el Sprint Review. Me aseguré de que la lógica visual reflejara fielmente las necesidades funcionales del sistema. <br> **TB2:** Apoyé en el diseño del protocolo de entrevistas y participé en las validaciones con usuarios. Aporté observaciones clave en la discusión de resultados y cómo estos se reflejaban en el sistema. | **TB1:** Destacó por representar la voz del usuario mediante elementos visuales. <br> **TP:** Mantuvo una comunicación visual clara en el desarrollo del módulo asignado, facilitando la integración con el resto del sistema. <br> **TB2:** Su enfoque comunicacional permitió interpretar y traducir las validaciones de usuario en mejoras específicas del sistema. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Machado Bracamonte, Ivo Marcelo** <br> **TB1:** Me encargué del sistema de etiquetado, mock-ups y diseño visual de la landing page. Aporté prototipos para guiar el desarrollo del frontend. <br> **TP:** Implementé y documenté vistas funcionales del frontend en mi carpeta de trabajo. Mostré visualmente los avances en el Sprint Review y elaboré evidencia gráfica con capturas y video del sistema. <br> **TB2:** Coordiné la presentación de evidencias visuales de implementación y validación. Elaboré recursos gráficos y esquemas explicativos para las entrevistas y para el informe final del Sprint. | **TB1:** Comunicó de forma visual ideas complejas que facilitaron la implementación. <br> **TP:** Destacó por su capacidad de comunicar avances visuales y funcionales a través de documentación multimedia clara y directa. <br> **TB2:** Reforzó su rol como comunicador visual al presentar información técnica e investigativa en formatos accesibles y comprensibles. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Aliaga Aguirre, Ethan Matías** <br> **TB1:** Contribuí al diseño orientado a objetos e implementación técnica de la landing page. Coordiné con el equipo para asegurar calidad estructural del sistema. <br> **TP:** Participé en el desarrollo técnico del módulo correspondiente a mi bounded context. Aporté evidencia de implementación y colaboré en tareas de integración del frontend. <br> **TB2:** Aporté en la revisión cruzada del código implementado, validando que los cambios respondieran a las entrevistas y evaluaciones heurísticas. Documenté mejoras técnicas aplicadas. | **TB1:** Facilitó el desarrollo estructurado gracias a una comunicación técnica constante. <br> **TP:** Mantuvo claridad técnica en sus contribuciones, alineando la implementación con el diseño y funcionalidad esperada. <br> **TB2:** Mostró una comunicación analítica al vincular hallazgos externos con decisiones técnicas dentro del sistema. |
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Contreras Lopez, Leandro Saúl** <br> **TB1:** Configuré el entorno de desarrollo común y gestioné el Product Backlog. También trabajé en las metaetiquetas SEO. <br> **TP:** Reestructuré la carpeta de trabajo para mi bounded context. Contribuí en la documentación del Sprint y la implementación de funcionalidades específicas. Organicé evidencias de implementación y validación de servicios. <br> **TB2:** Gestioné la integración de evidencias de entrevistas y evaluación heurística en el repositorio. Organicé las entregas del equipo y verifiqué que cumplieran con los criterios de formato. | **TB1:** Su aporte permitió un entorno de desarrollo claro y compartido. <br> **TP:** Logró comunicar con claridad los objetivos de su módulo, facilitando el seguimiento técnico y organizativo del equipo. <br> **TB2:** Aseguró una comunicación clara y estructurada entre los entregables del equipo y los criterios académicos requeridos. |
